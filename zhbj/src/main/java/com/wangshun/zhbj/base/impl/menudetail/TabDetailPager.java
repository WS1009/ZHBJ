...
import com.wangshun.zhbj.activity.NewsDetailActivity;
...
import com.wangshun.zhbj.domain.TabDetailBean;
import com.wangshun.zhbj.domain.TabDetailBean.News;
import com.wangshun.zhbj.domain.TabDetailBean.TopNews;
import com.wangshun.zhbj.global.GlobalContants;
import com.wangshun.zhbj.utils.BitmapHelper;
import com.wangshun.zhbj.utils.CacheUtils;
import com.wangshun.zhbj.utils.SharePreferenceUtils;
import com.wangshun.zhbj.view.HorizontalScrollViewPager;
import com.wangshun.zhbj.view.RefreshListView;
import com.wangshun.zhbj.view.RefreshListView.RefreshListener;
...
public class TabDetailPager extends BaseMenuDetailPager implements
    ...
    private static final int TOP_NEWS_CHANGE_TIME = 3000;// 顶部新闻切换事件
    ...
    public View initView() {
        ...
        View headerView = View.inflate(mActivity, R.layout.top_news_header_view, null);
    ...
    protected void processData(String result, boolean more) {
        ...
        //handler放在这里是为了让用户只有在进入此处时才会初始化handler
        if (mHandler == null) {
            // 创建轮播条的Handler
...
//                            });
                        ...
                        case MotionEvent.ACTION_CANCEL:
                            ...
                            //当按下viewpager后，直接滑动listview，导致事件无法响应
                            mHandler.sendEmptyMessageDelayed(0, TOP_NEWS_CHANGE_TIME);
                            break;
                        default:
                            break;
