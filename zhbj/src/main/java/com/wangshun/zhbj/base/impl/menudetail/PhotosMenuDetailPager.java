...
import com.wangshun.zhbj.domain.PhotosBean;
import com.wangshun.zhbj.global.GlobalContants;
import com.wangshun.zhbj.utils.CacheUtils;
import com.wangshun.zhbj.utils.Logger;
import com.wangshun.zhbj.utils.bitmap.MyBitmapUtils;
...
public class PhotosMenuDetailPager extends BaseMenuDetailPager {
	...
	private ArrayList<PhotosBean.PhotosNews> mPhotosList;// 组图数据集合
	...
	class PhotosAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (!TextUtils.isEmpty(getItem(position).listimage)) {
				...
				holder.ivPhoto
						.setImageResource(R.mipmap.pic_item_list_default);
			}
	...
	private void switchPhotosDisplay() {
		if (isListShow) {
			...
			btnPhotoSwitch.setImageResource(R.mipmap.icon_pic_list_type);
		} else {
			isListShow = true;
			...
			btnPhotoSwitch.setImageResource(R.mipmap.icon_pic_grid_type);
		}
	}
